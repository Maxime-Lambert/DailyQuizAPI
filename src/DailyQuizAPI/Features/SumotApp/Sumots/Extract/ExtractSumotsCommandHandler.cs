...
public sealed class ExtractSumotsCommandHandler(QuizContext quizContext, ICacheService cacheService)
{
    ...
    [
        ...
        "CHIARD",
        "CHIBRE",
        "CHIER", "CHIES", "CHIEZ", "CHIAIS", "CHIAIT", "CHIANT",
        "CHIEUR",
        "CHLEU", "CHLEUS",
        "CONARD",
        "CONNE", "CONNES",
        ...
        "MINUS",
        "NABOT", "NABOTS",
        "NEGRE", "NEGRO", "NEGRES", "NEGROS",
        "NIAFOU",
        "NIAQUE",
        "NIQUE", "NIQUA", "NIQUES", "NIQUEZ", "NIQUER", "NIQUAI", "NIQUAS",
        "PAKOS", "PAKPAK",
        "PECQUE",
        "PEDE", "PEDES",
        "PISSOU",
        ...
        "TOCARD",
        "TROON", "TROONS",
        "VIOLA", "VIOLE", "VIOLEE", "VIOLES", "VIOLEZ", "VIOLER", "VIOLS", "VIOLAI", "VIOLAS",
        "YOUTRE",
        "ZOBES"
    ];
    ...
    public async Task Handle(CancellationToken cancellationToken)
    {
        ...
        foreach (var sumot in sumotsFromLexique.Where(s => !existingSumots.Any(es => es.Word == s.Word)))
        {
...
#pragma warning restore CA1308 // Normaliser les chaînes en majuscules
    ...
    public async Task<List<Sumot>> LoadSumotsFromCsvAsync(string csvPath, CancellationToken cancellationToken)
    {
        ...
        int idxFreqFilm = Array.IndexOf(header, "freqfilms2");
        ...
        foreach (var line in lines.Skip(1))
        {
            ...
            var freqfilms2Str = cols[idxFreqFilm].Trim().Replace(',', '.');

            if (!double.TryParse(freqfilms2Str, NumberStyles.Any, CultureInfo.InvariantCulture, out var freqfilms2))
                freqfilms2 = 0;
